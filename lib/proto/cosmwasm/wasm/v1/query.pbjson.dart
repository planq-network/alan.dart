...
final $typed_data.Uint8List queryContractInfoResponseDescriptor = $convert.base64Decode('ChlRdWVyeUNvbnRyYWN0SW5mb1Jlc3BvbnNlEhgKB2FkZHJlc3MYASABKAlSB2FkZHJlc3MSVgoNY29udHJhY3RfaW5mbxgCIAEoCzIeLmNvc213YXNtLndhc20udjEuQ29udHJhY3RJbmZvQhHQ3h8ByN4fAKjnsCoB6t4fAFIMY29udHJhY3RJbmZvOgTooB8B');
...
final $typed_data.Uint8List queryContractHistoryResponseDescriptor = $convert.base64Decode('ChxRdWVyeUNvbnRyYWN0SGlzdG9yeVJlc3BvbnNlEk8KB2VudHJpZXMYASADKAsyKi5jb3Ntd2FzbS53YXNtLnYxLkNvbnRyYWN0Q29kZUhpc3RvcnlFbnRyeUIJyN4fAKjnsCoBUgdlbnRyaWVzEkcKCnBhZ2luYXRpb24YAiABKAsyJy5jb3Ntb3MuYmFzZS5xdWVyeS52MWJldGExLlBhZ2VSZXNwb25zZVIKcGFnaW5hdGlvbg==');
...
final $typed_data.Uint8List queryAllContractStateResponseDescriptor = $convert.base64Decode('Ch1RdWVyeUFsbENvbnRyYWN0U3RhdGVSZXNwb25zZRI6CgZtb2RlbHMYASADKAsyFy5jb3Ntd2FzbS53YXNtLnYxLk1vZGVsQgnI3h8AqOewKgFSBm1vZGVscxJHCgpwYWdpbmF0aW9uGAIgASgLMicuY29zbW9zLmJhc2UucXVlcnkudjFiZXRhMS5QYWdlUmVzcG9uc2VSCnBhZ2luYXRpb24=');
...
final $typed_data.Uint8List codeInfoResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List queryCodesResponseDescriptor = $convert.base64Decode('ChJRdWVyeUNvZGVzUmVzcG9uc2USTAoKY29kZV9pbmZvcxgBIAMoCzIiLmNvc213YXNtLndhc20udjEuQ29kZUluZm9SZXNwb25zZUIJyN4fAKjnsCoBUgljb2RlSW5mb3MSRwoKcGFnaW5hdGlvbhgCIAEoCzInLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlc3BvbnNlUgpwYWdpbmF0aW9u');
...
final $typed_data.Uint8List queryPinnedCodesResponseDescriptor = $convert.base64Decode('ChhRdWVyeVBpbm5lZENvZGVzUmVzcG9uc2USJgoIY29kZV9pZHMYASADKARCC+LeHwdDb2RlSURzUgdjb2RlSWRzEkcKCnBhZ2luYXRpb24YAiABKAsyJy5jb3Ntb3MuYmFzZS5xdWVyeS52MWJldGExLlBhZ2VSZXNwb25zZVIKcGFnaW5hdGlvbg==');
...
final $typed_data.Uint8List queryParamsResponseDescriptor = $convert.base64Decode('ChNRdWVyeVBhcmFtc1Jlc3BvbnNlEjsKBnBhcmFtcxgBIAEoCzIYLmNvc213YXNtLndhc20udjEuUGFyYW1zQgnI3h8AqOewKgFSBnBhcmFtcw==');
@$core.Deprecated('Use queryContractsByCreatorRequestDescriptor instead')
const QueryContractsByCreatorRequest$json = const {
  '1': 'QueryContractsByCreatorRequest',
  '2': const [
    const {'1': 'creator_address', '3': 1, '4': 1, '5': 9, '10': 'creatorAddress'},
    const {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.base.query.v1beta1.PageRequest', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryContractsByCreatorRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryContractsByCreatorRequestDescriptor = $convert.base64Decode('Ch5RdWVyeUNvbnRyYWN0c0J5Q3JlYXRvclJlcXVlc3QSJwoPY3JlYXRvcl9hZGRyZXNzGAEgASgJUg5jcmVhdG9yQWRkcmVzcxJGCgpwYWdpbmF0aW9uGAIgASgLMiYuY29zbW9zLmJhc2UucXVlcnkudjFiZXRhMS5QYWdlUmVxdWVzdFIKcGFnaW5hdGlvbg==');
@$core.Deprecated('Use queryContractsByCreatorResponseDescriptor instead')
const QueryContractsByCreatorResponse$json = const {
  '1': 'QueryContractsByCreatorResponse',
  '2': const [
    const {'1': 'contract_addresses', '3': 1, '4': 3, '5': 9, '10': 'contractAddresses'},
    const {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.base.query.v1beta1.PageResponse', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryContractsByCreatorResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryContractsByCreatorResponseDescriptor = $convert.base64Decode('Ch9RdWVyeUNvbnRyYWN0c0J5Q3JlYXRvclJlc3BvbnNlEi0KEmNvbnRyYWN0X2FkZHJlc3NlcxgBIAMoCVIRY29udHJhY3RBZGRyZXNzZXMSRwoKcGFnaW5hdGlvbhgCIAEoCzInLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlc3BvbnNlUgpwYWdpbmF0aW9u');
