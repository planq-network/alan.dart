...
const AccessType$json = const {
  ...
  '2': const [
    ...
    const {'1': 'ACCESS_TYPE_ANY_OF_ADDRESSES', '2': 4, '3': const {}},
  ],
  '3': const {},
};

/// Descriptor for `AccessType`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List accessTypeDescriptor = $convert.base64Decode('');
...
const AccessConfig$json = const {
  ...
  '2': const [
    ...
    const {'1': 'addresses', '3': 3, '4': 3, '5': 9, '8': const {}, '10': 'addresses'},
  ],
  '7': const {},
};

/// Descriptor for `AccessConfig`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List accessConfigDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List paramsDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List codeInfoDescriptor = $convert.base64Decode('CghDb2RlSW5mbxIbCgljb2RlX2hhc2gYASABKAxSCGNvZGVIYXNoEhgKB2NyZWF0b3IYAiABKAlSB2NyZWF0b3ISWAoSaW5zdGFudGlhdGVfY29uZmlnGAUgASgLMh4uY29zbXdhc20ud2FzbS52MS5BY2Nlc3NDb25maWdCCcjeHwCo57AqAVIRaW5zdGFudGlhdGVDb25maWdKBAgDEARKBAgEEAU=');
...
final $typed_data.Uint8List contractInfoDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List modelDescriptor = $convert.base64Decode('CgVNb2RlbBJGCgNrZXkYASABKAxCNPreHzBnaXRodWIuY29tL2NvbWV0YmZ0L2NvbWV0YmZ0L2xpYnMvYnl0ZXMuSGV4Qnl0ZXNSA2tleRIUCgV2YWx1ZRgCIAEoDFIFdmFsdWU=');
