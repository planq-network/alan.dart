...
class Proposal extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Proposal', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.gov.v1'), createEmptyInstance: create)
    ...
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'summary')
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proposer')
    ..hasRequiredFields = false
  ;
...
class Params extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Params', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.gov.v1'), createEmptyInstance: create)
    ..pc<$2.Coin>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minDeposit', $pb.PbFieldType.PM, subBuilder: $2.Coin.create)
    ..aOM<$5.Duration>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxDepositPeriod', subBuilder: $5.Duration.create)
    ..aOM<$5.Duration>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'votingPeriod', subBuilder: $5.Duration.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'quorum')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'threshold')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vetoThreshold')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minInitialDepositRatio')
    ..aOB(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'burnVoteQuorum')
    ..aOB(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'burnProposalDepositPrevote')
    ..aOB(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'burnVoteVeto')
    ..hasRequiredFields = false
  ;
  ...
  factory Params({
    ...
    if (minInitialDepositRatio != null) {
      _result.minInitialDepositRatio = minInitialDepositRatio;
    }
    if (burnVoteQuorum != null) {
      _result.burnVoteQuorum = burnVoteQuorum;
    }
    if (burnProposalDepositPrevote != null) {
      _result.burnProposalDepositPrevote = burnProposalDepositPrevote;
    }
    if (burnVoteVeto != null) {
      _result.burnVoteVeto = burnVoteVeto;
    }
    return _result;
  }
