...
final $typed_data.Uint8List capabilityDescriptor = $convert.base64Decode('CgpDYXBhYmlsaXR5EhQKBWluZGV4GAEgASgEUgVpbmRleDoEmKAfAA==');
...
final $typed_data.Uint8List ownerDescriptor = $convert.base64Decode('CgVPd25lchIWCgZtb2R1bGUYASABKAlSBm1vZHVsZRISCgRuYW1lGAIgASgJUgRuYW1lOgiYoB8AiKAfAA==');
@$core.Deprecated('Use capabilityOwnersDescriptor instead')
const CapabilityOwners$json = const {
  '1': 'CapabilityOwners',
  '2': const [
    const {'1': 'owners', '3': 1, '4': 3, '5': 11, '6': '.capability.v1.Owner', '8': const {}, '10': 'owners'},
  ],
};

/// Descriptor for `CapabilityOwners`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List capabilityOwnersDescriptor = $convert.base64Decode('ChBDYXBhYmlsaXR5T3duZXJzEjcKBm93bmVycxgBIAMoCzIULmNhcGFiaWxpdHkudjEuT3duZXJCCcjeHwCo57AqAVIGb3duZXJz');
